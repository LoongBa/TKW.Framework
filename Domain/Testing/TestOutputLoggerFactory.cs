...
public class TestOutputLoggerFactory : ILoggerFactory
{
    ...
    /// </summary>
    private readonly ITestWriter _TestOutput;
    ...
    public TestOutputLoggerFactory(ITestWriter testOutput)
    {
    ...
    /// </summary>
    private class TestOutputLogger(ITestWriter testOutput, string categoryName, TestOutputLoggerFactory factory)
        : ILogger
    {
        // 绑定所属工厂实例
    ...
    private class TestOutputLogger<T> : ILogger<T>
    {
        ...
        public TestOutputLogger(ITestWriter testOutput, TestOutputLoggerFactory factory)
        {
            var categoryName = typeof(T).FullName ?? nameof(T);
