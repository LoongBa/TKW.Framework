...
/// </summary>
public class LocalAppBuilder<TUserInfo, TInitializer, TOptions>(
    IDomainAppBuilderAdapter builder, TOptions options)
    : DomainAppBuilderBase<LocalAppBuilder<TUserInfo, TInitializer, TOptions>, TOptions, TUserInfo>(builder, options)
    ...
    where TOptions : DomainOptions, new()
{
    ...
    public LocalAppBuilder<TUserInfo, TInitializer, TOptions> NoSession()
    {
        return UseSessionManager<NoSessionManager<TUserInfo>>();
    }

    public LocalAppBuilder<TUserInfo, TInitializer, TOptions> UseLocalSession(string applicationName)
    {
