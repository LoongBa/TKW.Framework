    ...
    public class AuthorizeRequiredFilter : IAuthorizationFilter
    {
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            if (!string.IsNullOrWhiteSpace(sessionKey))
            {
                try
                {
                    domainUserSession = _ResumeUserSessionDelegate(sessionKey);
                }
            ...
            domainUserSession ??= _CreateNewUserSessionDelegate?.Invoke();
            ...
            if (domainUserSession != null)
            {
                ...
                {
                    context.HttpContext.User = domainUserSession.User;
                }

                WebTools.SetValue2SessionOrCookieOrHeaderOrQueryString(context.HttpContext, SessionkeyName, domainUserSession.Key);
            }
        ...
        public AuthorizeRequiredFilter(IUserSessionProvider userSessionProvider, bool return401Code = false, Func<DomainUserSession<DomainUser>, WebDomainUser> webUserConvertor = null)
        {
            ...
            _ResumeUserSessionDelegate = userSessionProvider.RetrieveAndActiveUserSession;
            _CreateNewUserSessionDelegate = userSessionProvider.NewGuestSession;
            _WebUserConvertor = webUserConvertor;
        }
    }
}
