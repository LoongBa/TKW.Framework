...
public static class BatchIdExtensions
{
    extension<T>(IEnumerable<T> source)
    {
        ...
        /// </summary>
        public IEnumerable<T> WithBatchIds(Func<T, DateTime> timestampSelector,
        ...
        /// </summary>
        public IReadOnlyList<T> ApplySortedBatchIds(Func<T, DateTime> timestampSelector,
            Action<T, string> idSetter,
        ...
        /// </summary>
        public IReadOnlyList<T> ApplyBatchIds(Func<T, DateTime> timestampSelector,
            Action<T, string> idSetter,
            string prefix = "")
        {
    ...
    extension<T>(IAsyncEnumerable<T> source)
    {
        ...
        /// 注意：未排序的数据可能导致生成的批次ID不连续！建议先对数据排序。
        /// </summary>
        public async IAsyncEnumerable<T> WithBatchIdsAsync(Func<T, DateTime> timestampSelector,
            Action<T, string> idSetter,
            string prefix = "")
        {
            ArgumentNullException.ThrowIfNull(source);
        ...
        /// </summary>
        public async IAsyncEnumerable<T> WithSortedBatchIdsAsync(Func<T, DateTime> timestampSelector,
            Action<T, string> idSetter,
            Func<T, object> sortSelector = null,
            string prefix = "")
        {
        ...
        /// </summary>
        public async ValueTask<IReadOnlyList<T>> ApplyBatchIdsAsync(Func<T, DateTime> timestampSelector,
            Action<T, string> idSetter,
            string prefix = "")
        {
            if (source == null)
        ...
        /// 注意：此方法会将数据全量加载到内存进行排序，大数据集需谨慎使用。
        /// </summary>
        public async ValueTask<IReadOnlyList<T>> ApplySortedBatchIdsAsync(Func<T, DateTime> timestampSelector,
            Action<T, string> idSetter,
            Func<T, object> sortSelector = null,
            string prefix = "")
        {
    ...
    extension<T>(IEnumerable<T> source)
    {
        ...
        /// </summary>
        public IEnumerable<TResult> MapWithBatchIds<TResult>(Func<T, DateTime> timestampSelector,
        ...
        /// </summary>
        public IEnumerable<TResult> MapWithSortedBatchIds<TResult>(Func<T, DateTime> timestampSelector,
            Func<T, string, TResult> resultSelector,
            Func<T, object> sortSelector = null,
            string prefix = "")
        {
    ...
    extension<T>(IAsyncEnumerable<T> source)
    {
        ...
        /// </summary>
        public async IAsyncEnumerable<TResult> MapWithBatchIdsAsync<TResult>(Func<T, DateTime> timestampSelector,
            Func<T, string, TResult> resultSelector,
            string prefix = "")
        {
            ArgumentNullException.ThrowIfNull(source);
        ...
        /// 注意：此方法会将数据全量加载到内存进行排序，大数据集需谨慎使用。
        /// </summary>
        public async IAsyncEnumerable<TResult> MapWithSortedBatchIdsAsync<TResult>(Func<T, DateTime> timestampSelector,
            Func<T, string, TResult> resultSelector,
            Func<T, object> sortSelector = null,
            string prefix = "")
        {
