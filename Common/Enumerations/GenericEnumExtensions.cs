...
public static class GenericEnumExtensions
{
    ...
    public static List<string> GetDisplayNames<T>() where T : struct, Enum
    ...
    public static Dictionary<T, string> GetValueDisplayMap<T>() where T : struct, Enum
    ...
    public static List<T> GetValuesByDisplay<T>(string displayName) where T : struct, Enum
