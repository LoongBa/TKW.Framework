// CodeMetaDataExtractor.Constants.cs
using System;
...
namespace xCodeGen.SourceGenerator
{
    public partial class CodeMetaDataExtractor
    {
        ...
        public const string NamespaceTemplate = "namespace {0}.Generated\r\n{{\r\n{1}}}\r\n";
        public const string ClassTemplate = "    public partial class {0}Meta\r\n    {{\r\n{1}    }}\r\n";
        ...
        {
            // 源生成器环境下不推荐使用文件系统操作，如需兼容可实现基础语法分析
